...
RUN apk upgrade --no-cache --no-progress \
  && apk add --no-cache --no-progress jq ca-certificates openssl \
...
LABEL source_repository="https://github.com/sapcc/gochangelog_ci" \
  org.opencontainers.image.url="https://github.com/sapcc/gochangelog_ci" \
...
ENTRYPOINT [ "/usr/bin/gochangelog_ci" ]
