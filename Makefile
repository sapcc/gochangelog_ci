...
install: FORCE build/gochangelog_ci
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/gochangelog_ci "$(DESTDIR)$(PREFIX)/bin/gochangelog_ci"
...
goimports: FORCE install-goimports
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/gochangelog_ci\e[0m\n"
	@goimports -w -local github.com/sapcc/gochangelog_ci $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
...
help: FORCE
	...
	@printf "  \e[36mbuild/gochangelog_ci\e[0m         Build gochangelog_ci.\n"
